package jerem.coopcycle.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("jerem.coopcycle.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("jerem.coopcycle.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
