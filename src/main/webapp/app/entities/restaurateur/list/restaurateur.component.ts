...
import { EntityArrayResponseType, RestaurateurService } from '../service/restaurateur.service';
...
export class RestaurateurComponent implements OnInit {
  ...
  trackId = (_index: number, item: IRestaurateur): number => this.restaurateurService.getRestaurateurIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.restaurateurs = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IRestaurateur[] | null): IRestaurateur[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.restaurateurService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
